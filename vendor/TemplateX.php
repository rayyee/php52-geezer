...
// @copyright https://github.com/wpscholar/templatex
// modified some code that compatible for php5.2
...
class TemplateX {
	 ...
	 */
	public function __construct( array $templatePaths = array() ) {
	 ...
	 */
	public function setContext( array $vars = array() ) {
		$this->vars = $vars;
	}
	 ...
	 * @return string
	 */
	public function load( $template, array $vars = array(), $withContext = true, $echo = true ) {
		if ( $withContext ) {
